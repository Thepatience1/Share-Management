...
const Section = () => {
  return (
    <>
      ...
      <div
       className="container flex flex-col-reverse items-center  px-6 mx-auto space-y-0 md:space-y-50 md:flex-row w-full h-screen text-center'"
      >
       
        <div className="flex flex-col mb-20 space-y-5 md:w-1/2">
          <h1
    ...
    <section id="2" className="bg-slate-100">
      ...
      <div
        className="container flex flex-col-reverse items-center mx-auto space-y-30 md:space-y-10 md:flex-row "
      >
        
       
        <div className="flex flex-col mb-30 space-y-5 md:w-1/2">
       
      <dev className=" flex-col items-center  space-y-6  border-green-500 md:flex rounded-xl hover:scale-105 ease-in duration-300 ">
      <a
          href="#"
